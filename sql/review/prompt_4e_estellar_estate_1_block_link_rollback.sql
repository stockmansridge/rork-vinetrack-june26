-- Prompt 4E — guarded Estellar Estate conditional ROLLBACK (1 pins)
...
do $rollback$
declare
 v_run_id constant uuid:='514aaaa4-7abe-411a-80c1-e6f9f4e5f076'; v_vineyard_id constant uuid:='00bb9a18-28da-4ba7-9136-b2c5a1b56fb5';
 v_expected_count constant integer:=1;
 v_expected constant jsonb:=$expected$[{"pin_id":"eeb37c41-592a-4a1e-a3f7-efb57374cd04","proposed_block_id":"2fb055a3-76e6-4ec4-ae81-c1fa9fcdc1ae","proposed_block_name":"G1 Pinot Noir"}]$expected$::jsonb;
...
where a.run_id='514aaaa4-7abe-411a-80c1-e6f9f4e5f076'::uuid group by a.run_id;
