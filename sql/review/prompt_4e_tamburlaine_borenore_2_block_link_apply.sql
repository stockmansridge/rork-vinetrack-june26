-- Prompt 4E — guarded Tamburlaine Borenore exact block-link repair APPLY (2 pins)
...
do $repair$
declare
  v_run_id constant uuid := '0aa13b8d-0ff7-48cb-92f5-91e94fc593f7';
  v_vineyard_id constant uuid := 'a18654f6-13ed-4438-998b-7a7e1d89181a';
  v_vineyard_name constant text := 'Tamburlaine Borenore';
  ...
  v_expected constant jsonb := $expected$[{"pin_id":"9bfe8744-2eaa-46bc-89c9-caace6308487","proposed_block_id":"29475366-3795-47bf-add9-85b259bbcb47","proposed_block_name":"Block 5 Grenache","pin_type":"Other","pin_mode":"Repairs","completion_state":"completed","pin_capture_time":"2026-09-09 21:44:54.037995+00","stored_latitude":-33.2684980100331,"stored_longitude":148.974141497304,"nearest_current_boundary_metres":"3.79"},{"pin_id":"a56b6275-0f83-472f-b239-0ce0a7fa6c16","proposed_block_id":"29475366-3795-47bf-add9-85b259bbcb47","proposed_block_name":"Block 5 Grenache","pin_type":"Other","pin_mode":"Repairs","completion_state":"completed","pin_capture_time":"2026-09-09 21:48:30.431215+00","stored_latitude":-33.2692411076587,"stored_longitude":148.97410721532,"nearest_current_boundary_metres":"8.91"}]$expected$::jsonb;
  v_candidate record;
...
from public.pin_block_link_repair_audit where run_id='0aa13b8d-0ff7-48cb-92f5-91e94fc593f7'::uuid group by run_id,status;
