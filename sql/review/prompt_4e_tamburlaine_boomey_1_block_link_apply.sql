-- Prompt 4E — guarded Tamburlaine Boomey exact block-link repair APPLY (1 pins)
...
do $repair$
declare
  v_run_id constant uuid := '891c96f1-7a54-4858-a0a1-b0865eb5de00';
  v_vineyard_id constant uuid := '2c1d6be9-b5e4-42ec-a328-5c734ef87bf1';
  v_vineyard_name constant text := 'Tamburlaine Boomey';
  ...
  v_expected constant jsonb := $expected$[{"pin_id":"9174dcae-8859-4a6b-ab27-eca1f59084ce","proposed_block_id":"90c9d26e-0f48-4be6-ac23-92707b56d367","proposed_block_name":"Block 7","pin_type":"Growth Stage EL1","pin_mode":"Growth","completion_state":"active","pin_capture_time":"2026-09-03 01:34:54.780013+00","stored_latitude":-32.9806057818467,"stored_longitude":148.976273821004,"nearest_current_boundary_metres":"7.38"}]$expected$::jsonb;
  v_candidate record;
...
from public.pin_block_link_repair_audit where run_id='891c96f1-7a54-4858-a0a1-b0865eb5de00'::uuid group by run_id,status;
