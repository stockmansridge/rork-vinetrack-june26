...
// Fertiliser products live in the shared saved chemical library
// (`saved_chemicals`, sql/111) and sync through `SavedChemicalSyncService`.
// Only records + allocations have dedicated fertiliser tables.
