...
struct NewMainTabView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            ...
            pruningYieldSettingsSync.configure(store: store, auth: auth)
    ...
    private var aggregatePendingUpserts: Int {
        pinSync.pendingUpsertCount
            ...
            + pruningYieldSettingsSync.pendingUpsertCount
    ...
    private var aggregatePendingDeletes: Int {
        pinSync.pendingDeleteCount
            ...
            + pruningYieldSettingsSync.pendingDeleteCount
    ...
    private var aggregateSyncError: String? {
        let messages = [
            ...
            pruningYieldSettingsSync.errorMessage,
        ]
        return messages
            .compactMap { $0 }
